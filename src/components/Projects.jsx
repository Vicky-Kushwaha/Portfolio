      ...
      <div className="projects_container">
        <div className="project">
          ...
          <div className="projectDetails">
            ...
            <div>
              <p>
                This feature-rich ecommerce website, developed from scratch
                using ReactJS, Redux, NodeJS, ExpressJS, MongoDB, and Material
                UI, I created seamless user experiences for product management,
                order processing, and user authentication and many more
                features.
              </p>
            </div>
            <div className="view">
