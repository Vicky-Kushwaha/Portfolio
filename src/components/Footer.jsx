    ...
    <>
      <footer>
        <div className="scroll_home">
          <div>
            <a href="#navbar">
              <img src="images/uparrow.png" alt="up arrow" width="50" />
            </a>
          </div>
        </div>
        <div className="contact_logo">
          ...
          <div>
            <a
              href="https://www.linkedin.com/in/vicky-kumar-352a212ab/"
              rel="noopener noreferrer"
              target="_blank"
            >
              <img src="images/linkdin.png" alt="linkdin" width="50" />
            </a>
          </div>
          <div className="email">
            <a
              href="mailto:muzvickykerma@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
